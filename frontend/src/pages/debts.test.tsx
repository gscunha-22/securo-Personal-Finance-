...
const api = vi.hoisted(() => {
  const emptyPlan = {
    ...
    cashflow: [{ month: 1, income: '0.00', fixed: '0.00', service: '0.00', reneg: null, balance: '0.00', balance_reneg: null }],
    paths: [
...
describe('DebtsPage', () => {
  it('shows the renegotiation workspace with inventory empty and the five-gate model', async () => {
    ...
    expect(await screen.findByText(t('intelligence.inventoryEmpty'))).toBeInTheDocument()
